...
% der_TH = [5 0.05 -0.01 -1];
% dM_val = [100 10 0 -10]; % works for ice

% der_TH = [20 4 2 1 0.8 0.6 0.2 0];
% dM_val = [16 8 4 2 -1 -2 -4 -8 -10]; %this works so so..

der_TH = [100 50 20 4 2 1 0.8 0.6 0.2 0];
dM_val = [24 16 8 4 2 1 -0.5 -1 -2 -4 -8]; %
...
Ts = 0.001;                     %recomputing at 1000Hz
